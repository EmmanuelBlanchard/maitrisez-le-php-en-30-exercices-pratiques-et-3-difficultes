...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 18 oct. 2021 à 16:11
...
(2, '35 Exercices JavaScript', '30 exercices JavaScript corrigés en vidéo (20 faciles, 7 moyens, 3 complexes) pour réviser variables, tableaux, objets...', 'JS2.png', 1),
...
(4, 'La refonte d\'un site web déjà en ligne', 'D\'un site statique ? un site dynamique. MVC, HTML/CSS/Bootstrap, PHP, JS/JQuery, MySQL/PDO, sécurité, MCD/MPD (MERISE)..', 'PHP2.png', 2),
