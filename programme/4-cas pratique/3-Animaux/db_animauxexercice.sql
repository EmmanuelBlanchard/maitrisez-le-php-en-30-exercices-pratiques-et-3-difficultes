...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 18 oct. 2021 à 20:01
...
--
-- Base de données : `db_animauxexercice`
--
...
ALTER TABLE `image_animal`
  ...
  ADD KEY `FK_IMAGE_IMAGE_ANIMAL` (`idImage`);
...
--
ALTER TABLE `animal`
  ADD CONSTRAINT `FK_TYPE_ANIMAL` FOREIGN KEY (`idType`) REFERENCES `type` (`idType`);

--
-- Contraintes pour la table `image_animal`
--
ALTER TABLE `image_animal`
  ADD CONSTRAINT `FK_ANIMAL_IMAGE_ANIMAL` FOREIGN KEY (`idAnimal`) REFERENCES `animal` (`idAnimal`),
  ADD CONSTRAINT `FK_IMAGE_IMAGE_ANIMAL` FOREIGN KEY (`idImage`) REFERENCES `image` (`IdImage`);
COMMIT;
